...
<footer id="colophon" class="bg-primary lg:pt-10 relative overflow-hidden">
	...
	<div class="container mx-auto pt-[60px] text-white">
		...
		<div class="footer-center pb-[43px] flex flex-col lg:flex-row justify-between gap-[140px] lg:gap-0 border-b-[1px] border-b-secondary">
			<div class="left-col">
			...
			<div class="right-col relative lg:static">
				<div class="mt-0 ml-[0px] lg:ml-0 h-[140px] logo scale-[0.6] lg:scale-100 absolute lg:static left-0 top-[-120px]">
					<svg class="z-[1] absolute left-0" xmlns="http://www.w3.org/2000/svg" width="256" height="40" viewBox="0 0 256 40" fill="none">
					...
					<svg class="svg-draw-animation absolute top-[-49px] left-[-82px]" xmlns="http://www.w3.org/2000/svg" width="450" height="151" viewBox="0 0 450 151" fill="none">
