...
<footer id="colophon" class="bg-primary lg:pt-10 relative overflow-hidden">
	...
	<div class="container mx-auto pt-[60px] text-white">
		...
		<div class="footer-center pb-[43px] flex flex-col lg:flex-row justify-between gap-[100px] lg:gap-0 border-b-[1px] border-b-secondary">
			<div class="left-col">
			...
			<div class="right-col relative lg:static">
				<div class="mt-0 ml-[-85px] lg:ml-0 h-[140px] logo lg:relative scale-[0.6] lg:scale-100 absolute left-0 top-[-100px]">
