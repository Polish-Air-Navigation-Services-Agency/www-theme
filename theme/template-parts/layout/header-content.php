...
<header id="masthead" class="absolute z-20 <?php if (current_user_can('administrator')) {
	...
	<div class="container lg:py-10 lg:mb-10 md:mb-0 flex justify-between lg:justify-normal items-center">
		...
		<div id="site-navigation" class="w-full bg-[#055bc0] lg:bg-transparent <?php if (is_home()) : echo 'text-white'; else : echo 'text-primary'; ?> absolute lg:static inset-x-0 top-full h-0 lg:h-auto overflow-auto lg:overflow-visible shadow-none transition-all duration-500" data-js="nav-container">
