...
<div class="form-basic cv">
  ...
  <div class="btn-submit hidden group relative flex gap-[10px] text-center max-w-full w-fit mx-auto [&_.wpcf7-spinner]:absolute [&_.wpcf7-spinner]:right-[-7px] [&_.wpcf7-spinner]:top-4 [&_svg_path]:hover:fill-secondary [&_svg_circle]:hover:stroke-secondary [&_p]:flex [&_p]:gap-[4px] [&_p]:!font-medium [&_p]:bg-primary [&_p]:hover:bg-white [&_p]:!rounded-full [&_p]:!px-6 [&_p]:!py-[11px] [&_p]:text-white [&_p]:hover:text-[#0F304D] transition ease duration-200">
    [submit "Wyślij"]
  ...
  <div class="btn-transparent group relative text-center max-w-full w-fit mx-auto [&_.wpcf7-spinner]:absolute [&_.wpcf7-spinner]:right-[-7px] [&_.wpcf7-spinner]:top-4 [&_svg_path]:hover:fill-secondary [&_svg_circle]:hover:stroke-secondary">
    [submit "Wyślij"]
    <svg class="absolute right-[26px] top-[14px] pointer-events-none" xmlns="http://www.w3.org/2000/svg" width="34" height="16" viewBox="0 0 34 16" fill="none">
