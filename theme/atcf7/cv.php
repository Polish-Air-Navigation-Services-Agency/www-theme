...
<div class="form-basic cv">
  ...
  <div class="btn-submit group relative flex gap-[10px] text-center max-w-full w-fit mx-auto [&_.wpcf7-spinner]:absolute [&_.wpcf7-spinner]:right-[-7px] [&_.wpcf7-spinner]:top-4 [&_svg_path]:hover:fill-secondary [&_svg_circle]:hover:stroke-secondary [&_input]:!bg-primary [&_input]:hover:bg-white [&_input]:!rounded-full [&_input]:!px-6 [&_input]:!py-[11px] [&_input]:text-white [&_input]:hover:text-[#0F304D] transition ease duration-200">
    [submit "Wyślij"]
