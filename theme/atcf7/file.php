...
<div class="form-basic">
  <div class="mb-[18px] lg:mb-[42px] flex flex-col lg:flex-row gap-[18px] lg:[&_p]:w-[calc(25%_-_13.5px)] ">
    ...
    <label for="your-file" class="flex justify-between items-center pl-4 pr-3 md:pl-6 min-w-0 w-full h-[55px] rounded-2xl border border-primary hover:border-secondary transition duration-200 bg-white placeholder:text-foreground text-foreground text-base cursor-pointer [&_br]:hidden" data-js="standard-file">
      <span class="truncate" data-js="standard-file-name">
        <?php esc_html_e('Include file', '_pansa') ?>
      </span>
      <svg data-js="standard-file-icon" class="shrink-0" width="10" height="11" viewBox="0 0 10 11" fill="none" xmlns="http://www.w3.org/2000/svg">
        <line y1="5.50293" x2="10" y2="5.50293" stroke="#8117EE" />
        <line x1="5" y1="0.5" x2="5" y2="10.5" stroke="#8117EE" />
      </svg>
    </label>[file* your-file id:your-file placeholder "Załącz plik*"]
  </div>
