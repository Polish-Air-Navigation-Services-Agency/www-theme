...
<div class="relative pt-[100px] lg:pt-[174px] pb-[25px] lg:pb-[45px] overflow-hidden">
    ...
    <div class="container w-full flex gap-[117px] <?php if ($cols_reverse) echo 'flex-col md:flex-row-reverse';
        ...
        <div class="col1 basis-1/2 flex-col">
            ...
            <?php if ($title) : ?>
                <p class="mb-[50px] text-[60px] text-primary leading-[72px] font-medium"><?php echo $title; ?></p>
            <?php endif; ?>
