...
<section class="pb-[100px] overflow-hidden">
    <div class="container mx-auto">
        <div class="wrapper relative">
            <svg data-js-parallax data-js-parallax-offset="50" class="decoration svg-draw-animation hidden lg:block absolute bottom-[-70px] left-[150px] z-[-1]" xmlns="http://www.w3.org/2000/svg" width="207" height="218" viewBox="0 0 207 218" fill="none">
