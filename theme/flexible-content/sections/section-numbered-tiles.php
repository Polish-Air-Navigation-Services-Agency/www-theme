...
<section class="bg-[#F6F8F9]">
    <div class="container pt-10">
        <div class="title-wrapper w-full flex-col justify-center items-center">
                ...
                ?>
                    <?php if ($tile) : ?>
                        <div class="tile-wrapper w-[355px] px-5 py-[30px] <?php if ($tileID == 1) echo 'bg-primary';
                            ...
                            <?php if ($tile['number']) : ?>
                                <p class="size-[92px] mb-[90px] text-[60px] text-primary leading-[72px] font-medium  <?php if ($tileID == 1) echo 'bg-secondary rounded-full';
