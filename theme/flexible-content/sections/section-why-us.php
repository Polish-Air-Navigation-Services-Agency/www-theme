...
<section class="relative pt-[100px] lg:pt-[140px] pb-[45px] lg:pb-[100px] overflow-hidden">
    ...
    <div class="video lg:w-[92%] [&>iframe]:w-full [&>iframe]:lg:h-[630px] relative">
        ...
        <div class="video-wrapper lg:w-full lg:h-[630x] [&>iframe]:w-full [&>iframe]:lg:h-[630px] video-player-wrapper relative h-[320px] desktop:h-[720px] wide:h-[750px] overflow-hidden clip-path-url-['#clipped-video'] after:content-[''] after:absolute after:top-0 after:left-0 after:z-[1] after:w-full after:transition after:duration-[300ms] after:ease-out after:bg-[url('<?php echo $video_thumbnail_url ?>')] after:bg-center after:bg-cover after:bg-no-repeat after:h-[320px] desktop:after:h-[700px] wide:after:h-[880px]" data-js="videoWrapper">
            <?php echo $video; ?>
        </div>
