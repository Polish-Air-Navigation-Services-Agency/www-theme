...
<section class="relative pt-[100px] lg:pt-[140px] pb-[45px] lg:pb-[100px] overflow-hidden">
    ...
    <div class="video lg:w-[92%] [&>iframe]:w-full [&>iframe]:h-[630px] relative">
        ...
        <?php echo $video; ?>
        <div class="desc-wrapper lg:w-[457px] lg:h-[443px] text-white bg-primary pt-[70px] px-5 lg:px-10 lg:absolute bottom-[-80px] right-0">
