                        ...
                        <div class="tile-wrapper flex justify-between items-center">
                            <div class="left-col w-[323px] flex gap-4">
                                ...
                                <div class="offer-details-wrapper">
                                    <?php if ($tile['title']) : ?>
                                        <p class="text-[30px] font-medium text-primary"><?php echo $tile['title']; ?></p>
                                    <?php endif; ?>
                            ...
                            <div class="right-col">
                                <?php if ($tile['url']) : ?>
                                    <a href="<?php echo $tile['url']; ?>" class="group pl-[30px] pr-[70px] rounded-full font-medium bg-primary hover:bg-white hover:text-primary hover:border hover:border-[#BEBFBF] focus:bg-pos-100 text-white disabled:!bg-[#C9C9C9] disabled:!bg-none disabled:!opacity-100 transition-all duration-200 relative text-center max-w-full w-fit ml-auto ">
