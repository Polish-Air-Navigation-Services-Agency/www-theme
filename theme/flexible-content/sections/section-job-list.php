    ...
    <div class="container mx-auto py-[100px]">
        <div class="tiles-wrapper">
            ...
            ?>
                ...
                ?>
                    <?php if ($tile) : ?>
                        <div class="tile-wrapper pb-10 pt-4 flex justify-between items-center">
                            ...
                            <div class="right-col">
                                <?php if ($tile['url']) : ?>
                                    <a href="<?php echo $tile['url']; ?>" class="group h-[50px] pl-[30px] pr-[70px] flex items-center justify-center rounded-full text-[18px] font-medium bg-primary hover:bg-white hover:text-primary hover:border hover:border-[#BEBFBF] focus:bg-pos-100 text-white disabled:!bg-[#C9C9C9] disabled:!bg-none disabled:!opacity-100 transition-all duration-200 relative text-center  w-fit border-b-[1px] border-b-[#BEBFBF]">
