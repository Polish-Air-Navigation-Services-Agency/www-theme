...
<section id="<?php if($section_id) : echo $section_id; ?>" class="relative w-full !h-[600px] md:!h-[700px] flex flex-col justify-center">
    ...
    <div class="container">
        ...
        <a href="<?php if($section_id) : echo $section_id; ?>" class="block cursor-pointer absolute bottom-6 left-1/2 -translate-x-1/2">
