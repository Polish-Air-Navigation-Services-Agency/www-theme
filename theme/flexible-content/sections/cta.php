...
<section id="<?php if ($section_id) : echo $section_id;
    ...
    <div class="container w-full flex flex-col lg:flex-row items-center justify-between">
        <?php if ($title) : ?>
            <h2 class="mb-[30px] lg:mb-0 max-w-[590px] text-white text-center lg:text-left text-[42px] lg:text-[60px] leading-[50px] lg:leading-[72px] font-medium"><?php echo $title; ?></h2>
        <?php endif; ?>
