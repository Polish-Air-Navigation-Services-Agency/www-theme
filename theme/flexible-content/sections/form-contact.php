                ...
                <div class="lg:basis-1/2 lg:pl-[100px] mb-10 lg:mb-0">
                    ...
                    <?php if ($image_url) : ?>
                        <div class="relative w-fit mb-3">
                            ...
                            <svg class="hidden min-w-[430px]:block absolute left-full top-1/2 -translate-y-1/2 max-h-[80%]" width="72" height="284" viewBox="1 0 85 284" fill="none" xmlns="http://www.w3.org/2000/svg">
