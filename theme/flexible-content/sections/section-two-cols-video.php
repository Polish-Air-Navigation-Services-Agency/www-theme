    ...
    <div class="lg:grid grid-cols-2">
        ...
        <?php if (isset($video)) : ?>
            <div class="col-start-1 row-start-1 relative 
                ...
                <?php if (!$description && !$description2 && !$title) : ?>
                    <svg data-js-parallax data-js-parallax-offset="100" class="svg-draw-animation hidden lg:block lg:absolute mb-5 lg:mb-0 top-12 -right-48" width="265" height="158" viewBox="0 0 265 158" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <?php else: ?>
                    <svg data-js-parallax data-js-parallax-offset="100" class="svg-draw-animation hidden lg:block lg:absolute mb-5 lg:mb-0 top-12 right-16" width="601" height="222" viewBox="0 0 601 222" fill="none" xmlns="http://www.w3.org/2000/svg">
