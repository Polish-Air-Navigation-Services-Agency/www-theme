...
<div class="relative w-full bg-primary pt-[140px]">
    <div class="decoration hidden lg:block absolute top-0 left-1/2 -translate-x-1/2 z-[-1]">
    ...
    <div class="pt-12 relative z-0 container">
        ...
        <div class="two-col flex flex-col lg:flex-row basis relative">
            <div class="decoration absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2">
            ...
            <div class="col2 basis-1/2">
                <?php if (isset($section_img)) : ?>
                    <img class="lg:absolute" src="<?php echo $section_img_url ?>" alt="section_image" class="test">
                <?php endif; ?>
            </div>
        </div>
    </div>
