(() => {
  ...
  var require_aos = __commonJS({
    "node_modules/.pnpm/aos@3.0.0-beta.6/node_modules/aos/dist/aos.js"(exports, module) {
      !function(e, t2) {
        "object" == typeof exports && "undefined" != typeof module ? module.exports = t2() : "function" == typeof define && define.amd ? define(t2) : e.AOS = t2();
      }(exports, function() {
        "use strict";
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {}, t2 = "Expected a function", n = NaN, o = "[object Symbol]", i2 = /^\s+|\s+$/g, a = /^[-+]0x[0-9a-f]+$/i, r = /^0b[01]+$/i, c = /^0o[0-7]+$/i, s = parseInt, u = "object" == typeof e && e && e.Object === Object && e, d = "object" == typeof self && self && self.Object === Object && self, l = u || d || Function("return this")(), f = Object.prototype.toString, m = Math.max, p = Math.min, b = function() {
          return l.Date.now();
        };
        function v(e2, n2, o2) {
          var i3, a2, r2, c2, s2, u2, d2 = 0, l2 = false, f2 = false, v2 = true;
          if ("function" != typeof e2) throw new TypeError(t2);
          function y2(t3) {
            var n3 = i3, o3 = a2;
            return i3 = a2 = void 0, d2 = t3, c2 = e2.apply(o3, n3);
          }
          function h2(e3) {
            var t3 = e3 - u2;
            return void 0 === u2 || t3 >= n2 || t3 < 0 || f2 && e3 - d2 >= r2;
          }
          function k2() {
            var e3 = b();
            ...
            s2 = setTimeout(k2, function(e4) {
              var t3 = n2 - (e4 - u2);
              return f2 ? p(t3, r2 - (e4 - d2)) : t3;
            }(e3));
          }
          function x2(e3) {
            return s2 = void 0, v2 && i3 ? y2(e3) : (i3 = a2 = void 0, c2);
          }
          function O2() {
            var e3 = b(), t3 = h2(e3);
            if (i3 = arguments, a2 = this, u2 = e3, t3) {
          ...
          return n2 = w(n2) || 0, g(o2) && (l2 = !!o2.leading, r2 = (f2 = "maxWait" in o2) ? m(w(o2.maxWait) || 0, n2) : r2, v2 = "trailing" in o2 ? !!o2.trailing : v2), O2.cancel = function() {
            void 0 !== s2 && clearTimeout(s2), d2 = 0, i3 = u2 = a2 = s2 = void 0;
          }, O2.flush = function() {
        ...
        var y = function(e2, n2, o2) {
          var i3 = true, a2 = true;
          if ("function" != typeof e2) throw new TypeError(t2);
          return g(o2) && (i3 = "leading" in o2 ? !!o2.leading : i3, a2 = "trailing" in o2 ? !!o2.trailing : a2), v(e2, n2, { leading: i3, maxWait: n2, trailing: a2 });
        ...
        var $ = function(e2, t3, n2) {
          var o2, i3, a2, r2, c2, s2, u2 = 0, d2 = false, l2 = false, f2 = true;
          if ("function" != typeof e2) throw new TypeError(h);
          function m2(t4) {
            var n3 = o2, a3 = i3;
            return o2 = i3 = void 0, u2 = t4, r2 = e2.apply(a3, n3);
          }
          function p2(e3) {
            var n3 = e3 - s2;
            return void 0 === s2 || n3 >= t3 || n3 < 0 || l2 && e3 - u2 >= a2;
          }
          function b2() {
            var e3 = S();
          ...
          function v2(e3) {
            return c2 = void 0, f2 && o2 ? m2(e3) : (o2 = i3 = void 0, r2);
          }
          function g2() {
            var e3 = S(), n3 = p2(e3);
            if (o2 = arguments, i3 = this, s2 = e3, n3) {
              if (void 0 === c2) return function(e4) {
                return u2 = e4, c2 = setTimeout(b2, t3), d2 ? m2(e4) : r2;
              }(s2);
              if (l2) return c2 = setTimeout(b2, t3), m2(s2);
            }
            return void 0 === c2 && (c2 = setTimeout(b2, t3)), r2;
          }
          return t3 = H(t3) || 0, D(n2) && (d2 = !!n2.leading, a2 = (l2 = "maxWait" in n2) ? T(H(n2.maxWait) || 0, t3) : a2, f2 = "trailing" in n2 ? !!n2.trailing : f2), g2.cancel = function() {
            void 0 !== c2 && clearTimeout(c2), u2 = 0, o2 = s2 = i3 = c2 = void 0;
          }, g2.flush = function() {
        ...
        function P(e2) {
          e2 && e2.forEach(function(e3) {
            var t3 = Array.prototype.slice.call(e3.addedNodes), n2 = Array.prototype.slice.call(e3.removedNodes);
            if (function e4(t4) {
              var n3 = void 0, o2 = void 0;
              for (n3 = 0; n3 < t4.length; n3 += 1) {
                if ((o2 = t4[n3]).dataset && o2.dataset.aos) return true;
                if (o2.children && e4(o2.children)) return true;
              }
              return false;
            }(t3.concat(n2))) return W();
          });
        }
        function Y() {
        ...
        var _ = { isSupported: function() {
          return !!Y();
        }, ready: function(e2, t3) {
          var n2 = window.document, o2 = new (Y())(P);
          W = t3, o2.observe(n2.documentElement, { childList: true, subtree: true, removedNodes: true });
        } }, B = function(e2, t3) {
        ...
        var U = new (function() {
          ...
          var n2 = void 0;
          return U.ie11() ? (n2 = document.createEvent("CustomEvent")).initCustomEvent(e2, true, true, { detail: t3 }) : n2 = new CustomEvent(e2, { detail: t3 }), document.dispatchEvent(n2);
        }, X = function(e2) {
          return e2.forEach(function(e3, t3) {
            return function(e4, t4) {
              var n2 = e4.options, o2 = e4.position, i3 = e4.node, a2 = (e4.data, function() {
                e4.animated && (function(e5, t5) {
                  t5 && t5.forEach(function(t6) {
                    return e5.classList.remove(t6);
                  });
                }(i3, n2.animatedClassNames), V("aos:out", i3), e4.options.id && V("aos:in:" + e4.options.id, i3), e4.animated = false);
              });
              n2.mirror && t4 >= o2.out && !n2.once ? a2() : t4 >= o2.in ? e4.animated || (function(e5, t5) {
                t5 && t5.forEach(function(t6) {
                  return e5.classList.add(t6);
                });
              }(i3, n2.animatedClassNames), V("aos:in", i3), e4.options.id && V("aos:in:" + e4.options.id, i3), e4.animated = true) : e4.animated && !n2.once && a2();
        ...
        }, ee = function(e2, t3, n2) {
          var o2 = e2.getAttribute("data-aos-" + t3);
          if (void 0 !== o2) {
          ...
          return e2.forEach(function(e3, n2) {
            var o2 = ee(e3.node, "mirror", t3.mirror), i3 = ee(e3.node, "once", t3.once), a2 = ee(e3.node, "id"), r2 = t3.useClassNames && e3.node.getAttribute("data-aos"), c2 = [t3.animatedClassName].concat(r2 ? r2.split(" ") : []).filter(function(e4) {
              return "string" == typeof e4;
            });
            t3.initClassName && e3.node.classList.add(t3.initClassName), e3.position = { in: function(e4, t4, n3) {
              var o3 = window.innerHeight, i4 = ee(e4, "anchor"), a3 = ee(e4, "anchor-placement"), r3 = Number(ee(e4, "offset", a3 ? 0 : t4)), c3 = a3 || n3, s2 = e4;
              i4 && document.querySelectorAll(i4) && (s2 = document.querySelectorAll(i4)[0]);
              var u2 = Z(s2).top - o3;
              switch (c3) {
                case "top-bottom":
                  break;
              ...
              return u2 + r3;
            }(e3.node, t3.offset, t3.anchorPlacement), out: o2 && function(e4, t4) {
              window.innerHeight;
              var n3 = ee(e4, "anchor"), o3 = ee(e4, "offset", t4), i4 = e4;
              return n3 && document.querySelectorAll(n3) && (i4 = document.querySelectorAll(n3)[0]), Z(i4).top + i4.offsetHeight - o3;
            }(e3.node, t3.offset) }, e3.options = { once: i3, mirror: o2, animatedClassNames: c2, id: a2 };
          }), e2;
        }, ne = function() {
  ...
  function initCounter() {
    ...
    for (let i2 = 1; i2 <= countersQty; i2++) {
      new i(
        `target${i2}`,
        +document.querySelector(`[data-counter-target${i2}]`).innerHTML,
        {
          separator: "",
          duration: 2,
  ...
  function initShowMoreJobs() {
    ...
    function expandJobsList(increment) {
      ...
      for (let i2 = 0; i2 < limit; i2++) {
        hiddenJobsList[i2].setAttribute("data-js-job-visible", "true");
      }
  ...
  function initParallaxes() {
    ...
    function applyParallax(element) {
      ...
      const parallaxOffset = customOffset !== null ? customOffset : isMobile() ? PARALLAX_OFFSET_MOBILE : PARALLAX_OFFSET_DESKTOP;
